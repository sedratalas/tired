...
class CategoryService {
  ...
  Future<List<Subject>> fetchSubjects(int categoryId) async {
    final response = await http.get(
      Uri.parse('http://192.168.1.105:8000/api/subjects?categoryId=$categoryId'),
      headers: <String, String>{
        'Authorization': 'Bearer $token',
      },
    );
